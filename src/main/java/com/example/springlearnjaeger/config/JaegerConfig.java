package com.example.springlearnjaeger.config;
...
public class JaegerConfig {
    ...
    public static JaegerTracer jaegerTracer() {
        ...
        io.jaegertracing.Configuration config = new io.jaegertracing.Configuration("jaeger-service").withSampler(samplerConfig).withReporter(reporterConfig);
